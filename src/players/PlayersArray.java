...
public class PlayersArray {
    ...
    public static Player[] findAll() {
        return new Player[]{
                new Quarterback("Aaron Rodgers", 12, "Packers", "QB", 50.00), //  "QB", 62.3), //
                ...
                // Cowboys
                new Quarterback("Dak Prescott", 4, "Cowboys", "QB", 50.00),
                ...
                // Patriots
                new Quarterback("Tom Brady", 12, "Patriots", "QB", 50.00),
